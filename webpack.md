...
- yarn add clean-webpack-plugin@4 -D    webpack只能用上一个版本的
...
-     [Uncaught TypeError: Cannot assign to read only property 'exports' of object '#<Object>'.](https://stackoverflow.com/questions/42449999/webpack-import-module-exports-in-the-same-module-caused-error)
...
- [图片打包到公共img文件夹下，页面取不到图片问题（图片查找路径被添加了css/img/xxx）](https://segmentfault.com/q/1010000014640043)
...
- 使用html-withimg-loader 引用图片地址变为  <img src={"default":"389a66a25c539a9fd3524d58c43e2560.png"}>
...
- 通过默认的devServer配置启动的服务，打包的动态链接库找不到，需要配置contentBase
